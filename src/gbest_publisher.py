...
def euclidean_distance( goal_point_x,goal_point_y,robot_pose_x, robot_pose_y):
	...
	return distance
def callback(msg1,msg2,msg3,msg4,msg5,msg6,msg7,msg8,msg9):
	distance_buffer=[]
...
ts = message_filters.ApproximateTimeSynchronizer([sub_9,sub_8,sub_7,sub_6,sub_5,sub_4,sub_3,sub_2,sub_1], 10, 0.1, allow_headerless=True)
